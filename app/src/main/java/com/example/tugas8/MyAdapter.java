...
import static com.example.tugas8.DBmain.TABLENAME;
...
public class MyAdapter extends
    ...
    public MyAdapter(Context context, int singledata,
    ...
    @NonNull
    @Override
    public MyAdapter.ViewHolder onCreateViewHolder(@NonNull
                        ...
                        switch (item.getItemId()){
                            case R.id.edit_menu:
                                ...
                                case R.id.delete_menu:
                                    ...
                                    long recdelete =
                                            sqLiteDatabase.delete(TABLENAME,"id="+model.getId(),null);
                                    if (recdelete != -1){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            txtprice = (TextView)
                    itemView.findViewById(R.id.txt_price);
